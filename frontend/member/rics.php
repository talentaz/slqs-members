...
<?php
    if (is_user_logged_in()) {
      ...
      ?>
      <div class="mt-2">
            <button type="button" class="btn btn-primary" data-toggle="modal" data-target="#memberRic">
                Edit
            </button>
      </div>
      <div class="modal fade" id="memberRic" tabindex="-1" role="dialog" aria-labelledby="memberRicTitle" aria-hidden="true">
  <div class="modal-dialog modal-dialog-centered" role="document">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title">Edit RICS/AIQA Assessors</h5>
        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
          <span aria-hidden="true">&times;</span>
        </button>
      </div>
      <form></form>
      <form class="custom-validation" id="slqs-member-ric-edit-form" method="post" enctype="multipart/form-data">
        <input type="hidden" name="slqs_ric_edit" value="1">
