            ...
            $member_details = "
                <table style='margin-top: -500px;'>
                    ...
                    <tr>
                        ...
                        <td>" . esc_html($current_address) . "</td>
                    </tr>
                    <tr>
                        <td>Mobile Number * (Primary)</td>
                        <td>" . esc_html($mobile_primary) . "</td>
                    </tr>
                    <tr>
                        <td>Mobile Number (Alternative)</td>
                        <td>" . esc_html($mobile_alternative) . "</td>
                    </tr>
                    <tr>
                        <td>E-mail Address * (Primary)</td>
                        <td>" . esc_html($email) . "</td>
                    </tr>
                    <tr>
                        <td>E-mail Address (Alternative)</td>
                        <td>" . esc_html($email_alternative) . "</td>
                    </tr>
                    <tr>
                        <td>Joining Date for the 1st Job in UAE</td>
                        <td>" . esc_html($joining_date) . "</td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                        <td>Name</td>
                        <td>" . esc_html($current_employer) . "</td>
                    </tr>
                    <tr>
                        <td>Employer Address</td>
                        <td>" . esc_html($employer_address) . "</td>
                    </tr>
                    <tr>
                        <td>Company Phone Number</td>
                        <td>" . esc_html($company_phone) . "</td>
                    </tr>
                    <tr>
                        <td>Company E-mail Address</td>
                        <td>" . esc_html($company_email) . "</td>
                    </tr>
                    <tr>
                        <td>Current Position</td>
                        <td>" . esc_html($current_position) . "</td>
                    </tr>
                    <tr>
                        <td colspan='2'>Emergency Contact Name and Relationship to Applicant</td>
                    </tr>
                    <tr>
                        <td>Name</td>
                        <td>" . esc_html($emergency_contact_name) . "</td>
                    </tr>
                    <tr>
                        <td>Relationship to Applicant</td>
                        <td>" . esc_html($emergency_contact_relationship) . "</td>
                    </tr>
                    <tr>
                        <td>Address </td>
                        <td>" . esc_html($emergency_contact_address) . "</td>
                    </tr>
                    <tr>
                        <td>Mobile Number</td>
                        <td>" . esc_html($emergency_contact_mobile) . "</td>
                    </tr>
                    <tr>
                        <td>E-mail</td>
                        <td>" . esc_html($emergency_contact_email) . "</td>
                    </tr>
                    <tr>
                        <td colspan='2'>Referee</td>
                    </tr>
                    <tr>
                        <td>Name of SLQS Member</td>
                        <td>" . esc_html($referee_name) . "</td>
                    </tr>
                    <tr>
                        <td>Membership No</td>
                        <td>" . esc_html($referee_membership_no) . "</td>
                    </tr>
                    <tr>
                        <td>Mobile Number</td>
                        <td>" . esc_html($referee_mobile) . "</td>
                    </tr>
                </table>
                ";
